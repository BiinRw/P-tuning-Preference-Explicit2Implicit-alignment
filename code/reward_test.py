...
test_path = '../datasets/false_qa_reward_valid.jsonl'
...
generation_config = GenerationConfig(
    ...
    max_new_tokens=100,                   # Set maximum number of new tokens to add to the input
    temperature=0.1,                    # Set temperature for sampling to 0.1
)

if __name__ == "__main__":
    # Create test dataloader using the TextDataset class
    test_dataloader = prompt_dataset.TextDataset(test_path, tokenizer=tokenizer, mode='test')
    ...
    peft_model = PeftModel.from_pretrained(
        model,
        './model_output/rm-llama2-r16/checkpoint-2300',
